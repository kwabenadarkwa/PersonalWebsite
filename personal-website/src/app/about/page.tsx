export default function Blog() {
  return (
    <div className="font-main">
      ...
      <div className="py-5">
        I am KD the great software engineer, known for fixing every bug <br />{' '}
        ever encountered. On a normal day you would find me either aggressively
        writing code with the energy of a thousand buffalos <br />
        to watching anime like it&apos;s my day job. my girlfirend <br /> 20/24
