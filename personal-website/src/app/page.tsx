    ...
    return (
        <div>
            ...
            <div className="relative h-fit overflow-hidden flex items-center justify-center z-10">
                <div className="font-main max-w-2xl mx-auto text-center space-y-4 sm:space-y-8">
                    ...
                    <div className="space-y-6">
                        <div className="text-[#facc15] text-xl sm:text-2xl font-bold">
                    ...
                    <div className="text-white/80 text-base sm:text-lg leading-relaxed max-w-lg mx-auto">
